...
public class BeerServiceImpl implements BeerService {
    ...
    public Mono<BeerDto> getById(Integer beerId, Boolean showInventoryOnHand) {
        ...
        if(showInventoryOnHand) return beerRepository.findById(beerId).map(beerMapper::beerToBeerDtoWithInventory);
        else return beerRepository.findById(beerId).map(beerMapper::beerToBeerDto);
    }
